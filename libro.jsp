...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript" src="guion/librogui.js"></script>
		</script>
			...
			<div id="som2">
				<div id="menu">
					<div id="cmenu">
						...
						<a href="libro.jsp"><div class="elemenu" id="seleccionado" >Libros</div></a>
				...
				<div id="contenido">
					<div id="izquierdo">
						En este apartado podrá consultar libros del Tribunal Federal de Justicia Fiscal y Administrativa.
						Los libros se despliegan por su fecha de publicación a continuación:
						<div id="obras">
						<%
							conexion=con.conectar();
							statem = conexion.createStatement();
							stateme = conexion.createStatement();
							rsc = statem.executeQuery("SELECT COUNT(*) FROM mlibro");
							if(rsc.next())
							{
							...
							rsc = statem.executeQuery("SELECT * FROM marticulo RIGHT JOIN mlibro ON marticulo.codigo_art=mlibro.codigo_art ORDER BY fecha_publicacion DESC LIMIT 10");
							while(rsc.next())
							{
								out.println("<a href=\"articulo.jsp?codart="+rsc.getString("codigo_art")+"\">");
									out.println("<div class=\"unobra\">");
										...
										out.println("<div class=\"infoob\">");
											...
											rste = stateme.executeQuery("SELECT descripcion_tomo FROM ctomo WHERE id_tomo="+rsc.getString("id_tomo"));
											if(rste.next())
											{
						...
						<div id="checks">
							...
							<form method="post" action="Busqueda">
								<table cellspacing="0" cellpadding="0" id="tabch">
									...
									<tr><td class="tder">Tomo:</td><td><input type="text" id="tomo" name="tomo" class="texto tatex" onkeyup="moPal('palo6', this.id)" onblur="moPal('palo6', this.id)" /></td><td><img src="img/paloma.png" id="palo6" style="display:none" /></td></tr>
					...
					<div id="derecho">
						...
						<div id="elementos">
							<%
								...
								rs=stat.executeQuery("SELECT codigo_art, img_art FROM marticulo WHERE id_tipo=1 ORDER BY visitas_art DESC LIMIT 10");
								while(rs.next())
								{
									++i;
									codigo = rs.getString("codigo_art");
									rsn=state.executeQuery("SELECT titulo_art, descripcion_art, autor_art FROM mlibro WHERE codigo_art='"+codigo+"'");
