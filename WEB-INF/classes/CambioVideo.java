...
public class CambioVideo extends HttpServlet
{
	String codigo, titulo, tituloalt, asunto, autor, duracion, fechac, descripcion, formatoimg, formato, publicador, programa;
	Conexion objCon;
	Connection con;
	Statement stm;
	PrintWriter out;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		try
		{
			...
			stm.executeUpdate("UPDATE mvideo SET titulo_art='"+titulo+"', nomalternativo_art='"+tituloalt+"', descripcion_art='"+descripcion+"', asunto_art='"+asunto+"', fecha_creacion_art='"+fechac+"', autor_art='"+autor+"', duracion_video='"+duracion+"', id_formato='"+formatoimg+"' WHERE codigo_art='"+codigo+"'");
