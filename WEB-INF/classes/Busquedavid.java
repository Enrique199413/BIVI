...
public class Busquedavid extends HttpServlet
{
	String titulo, tituloalt, descripcion, asunto, autor, where;
	Conexion objCon;
	Connection con;  
	Statement stm;
	PrintWriter out;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		if(boleano)
		{
			...
			try
			{
				rs = stm.executeQuery("SELECT codigo_art, titulo_art, descripcion_art FROM mvideo WHERE "+where);
				if(rs.next())
				{
					rs.beforeFirst();
					out.println("<html>");
