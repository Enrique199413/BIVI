...
public class CargarArticuloCambio extends HttpServlet
{
	String edicion;
	Conexion objCon;
	Connection con;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		try
		{
			...
			while(rs.next())
			{
				out.println("<form method=\"post\" action=\"CambiarArticulo\" class=\"camart\"><tr><td class=\"unart\"><span class=\"resaltar\">Codigo:</span>"+rs.getString("codigo_art")+"<br><span class=\"resaltar\">Título:</span>"+rs.getString("titulo_art")+"</td><td class=\"unart\"><input type=\"hidden\" value=\""+rs.getString("codigo_art")+"\" name=\"codigo\"/><input type=\"hidden\" value=\""+rs.getString("id_tipo")+"\" name=\"tipo\"/><input type=\"submit\" value=\"Cambiar\" class=\"boton\"/></td></tr></form>");
			}
