...
public class CambioLibro extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		try
		{
			...
			stm.executeUpdate("UPDATE mlibro SET id_editorial="+editorial+", titulo_art='"+titulo+"', nomalternativo_art='"+tituloalt+"', descripcion_art='"+descripcion+"', asunto_art='"+asunto+"', fecha_creacion_art='"+fechac+"', autor_art='"+autor+"', id_edicion="+edicion+", id_tomo="+tomo+"WHERE codigo_art='"+codigo+"'");
