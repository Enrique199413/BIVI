...
public class AltaRevista extends HttpServlet
{
	String codigo, titulo, tituloalt, asunto, autor, fechac, fechap, descripcion, editorial, edicion, nodrev, formato, publicador, programa, rutatexto, rutaimg;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
				...
				switch(j)
				{
					case 0:
						try
						{
							...
							out.println("<div class=\"naranja\">La revista se ha enviado correctamente al servidor.</div>");
						}
						catch(Exception e)
						{
							rutatexto="";
							out.println("<div class=\"rojo\">La revista no se ha enviado correctamente al servidor.</div>");
						}
					break;
					...
					case 1:
						try
						{
							...
							item.write(savedFile);
							out.println("<div class=\"naranja\">La imagen de la revista se ha enviado correctamente al servidor.</div>");
							out.println("<input type=\"button\" class=\"boton\" value=\"Generar thumbnail\" onclick=\"top.genThumbnailRev(\'"+rutaimg+"\')\" />");
						}
						catch(Exception e)
						{
							rutaimg="";
							out.println("<div class=\"rojo\">La imagen de la revista no se ha enviado correctamente al servidor.</div>");
						}
					default:
		...
		try
		{
			stm.executeUpdate("INSERT INTO marticulo VALUES ('"+codigo+"', DEFAULT, 'archivo/"+rutaimg+"', "+formato+", "+publicador+", "+programa+", 2)");
			stm.executeUpdate("INSERT INTO mrevista VALUES ('"+codigo+"', '"+fechap+"', 'archivo/"+rutatexto+"', "+editorial+", '"+titulo+"', '"+tituloalt+"', '"+descripcion+"', '"+asunto+"', '"+fechac+"', '"+autor+"', "+edicion+", "+nodrev+")");
