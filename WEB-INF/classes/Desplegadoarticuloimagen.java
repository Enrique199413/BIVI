...
public class Desplegadoarticuloimagen extends HttpServlet
{
	int parametro;
	Conexion objCon;
	Connection con;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			rs = stm.executeQuery("SELECT * FROM marticulo RIGHT JOIN mimagen ON marticulo.codigo_art=mimagen.codigo_art ORDER BY fecha_publicacion DESC LIMIT "+((parametro*10)-10)+", 10");
			while(rs.next())
			{
					...
					out.println("<div class=\"unobra\">");
						...
						out.println("<div class=\"infoob\">");
							...
							out.println("<span class=\"tit2\">Autor: </span>"+rs.getString("autor_art")+"<br>");
								...
								out.println("<span class=\"tit2\">Pie de foto: </span>"+rs.getString("pie_imagen")+"<br>");
