...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript" src="guion/imagengui.js"></script>
		</script>
			...
			<div id="som2">
				<div id="menu">
					<div id="cmenu">
						...
						<a href="imagen.jsp"><div class="elemenu" id="seleccionado" >Imágenes</div></a>
				...
				<div id="contenido">
					<div id="izquierdo">
						En este apartado podrá consultar imagenes del Tribunal Federal de Justicia Fiscal y Administrativa.
						Las imagenes se despliegan por su fecha de publicación a continuación:
						<div id="obras">
						<%
							conexion=con.conectar();
							statem = conexion.createStatement();
							stateme = conexion.createStatement();
							rsc = statem.executeQuery("SELECT COUNT(*) FROM mimagen");
							if(rsc.next())
							{
							...
							rsc = statem.executeQuery("SELECT * FROM marticulo RIGHT JOIN mimagen ON marticulo.codigo_art=mimagen.codigo_art ORDER BY fecha_publicacion DESC LIMIT 10");
							while(rsc.next())
							{
									...
									out.println("<div class=\"unobra\">");
										...
										out.println("<div class=\"infoob\">");
											...
											out.println("<span class=\"tit2\">Autor: </span>"+rsc.getString("autor_art")+"<br>");
												...
												out.println("<span class=\"tit2\">Pie de foto: </span>"+rsc.getString("pie_imagen")+"<br>");
						...
						<div id="checks">
							...
							<br>
							<!--[if gt IE 6]><center><![endif]-->
							<form method="post" action="Busquedaimg">
								<table cellspacing="0" cellpadding="0" id="tabch">
									...
									<tr><td class="tder">Pie de foto:</td><td><input type="text" id="editorial" name="pief" class="texto tatex" onkeyup="moPal('palo4', this.id)" onblur="moPal('palo4', this.id)" /></td><td><img src="img/paloma.png" id="palo4" style="display:none" /></td></tr>
					...
					<div id="derecho">
						...
						<div id="elementos">
							<%
								...
								rs=stat.executeQuery("SELECT codigo_art, img_art FROM marticulo WHERE id_tipo=3 ORDER BY visitas_art DESC LIMIT 10");
								while(rs.next())
								{
									++i;
									codigo = rs.getString("codigo_art");
									rsn=state.executeQuery("SELECT titulo_art, descripcion_art, autor_art FROM mimagen WHERE codigo_art='"+codigo+"'");
