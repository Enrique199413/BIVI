...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript" src="guion/bajagui.js"></script>
		<LINK REL="StyleSheet" HREF="estilo/style2.css" TYPE="text/css">
		<LINK REL="StyleSheet" HREF="estilo/bajas.css" TYPE="text/css">
	</head>
			...
			<div id="som2">
				<div id="menu">
					<div id="cmenu">
						...
						<a href="baja.jsp"><div class="elemenu" id="seleccionado">Baja</div></a>
					...
					<div id="formularios">
						...
						<div id="articulod" class="divderfor" style="display:none;">
							<div class="instrucciones">
								Para borrar artículos, selecciónelos y haga clic en el botón borrar.
							</div>
						...
						<div id="idiomad" style="display:none;" class="divderfor">
							<div class="instrucciones">
								Para borrar un idioma selecciónelo y haga clic en el botón borrar.
							</div>
							<div class="respuesta"></div>
							<div id="contenedoridiomad">
								<form method="post" action="BorrarIdioma" class="demas">
